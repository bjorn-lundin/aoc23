pragma Warnings (Off);
pragma Ada_95;
pragma Source_File_Name (ada_main, Spec_File_Name => "b__day01b.ads");
pragma Source_File_Name (ada_main, Body_File_Name => "b__day01b.adb");
...
package body ada_main is
   ...
   E115 : Short_Integer; pragma Import (Ada, E115, "ada__strings__text_buffers__unbounded_E");
   ...
   E149 : Short_Integer; pragma Import (Ada, E149, "filehandling_E");
   ...
   begin
      ...
      declare
         procedure F1;
         pragma Import (Ada, F1, "filehandling__finalize_spec");
      begin
         F1;
      end;
      E163 := E163 - 1;
      ...
      declare
         procedure F6;
         pragma Import (Ada, F6, "ada__strings__text_buffers__unbounded__finalize_spec");
      begin
         F6;
      end;
      E121 := E121 - 1;
   ...
   begin
      ...
      E163 := E163 + 1;
      Filehandling'Elab_Spec;
      E149 := E149 + 1;
   end adainit;

   procedure Ada_Main_Program;
   pragma Import (Ada, Ada_Main_Program, "_ada_day01b");
...
--  BEGIN Object file/option list
   --   /usr2/wcs/git/aoc23/01/obj/filehandling.o
   --   /usr2/wcs/git/aoc23/01/obj/day01b.o
   --   -L/usr2/wcs/git/aoc23/01/obj/
   --   -L/usr2/wcs/git/aoc23/01/obj/
   --   -L/usr2/wcs/tools/gnat/22.1/lib/gcc/x86_64-pc-linux-gnu/10.3.1/adalib/
   --   -static
   --   -lgnat
   --   -ldl
